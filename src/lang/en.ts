export const en = {
  ...
  common: {
    ...
    notifications: {
      ...
      create_stock_riven: {
        error: { title: "Create Stock Riven Error", message: "An error occurred while trying to create stock riven." },
        success: { title: "Create Stock Riven Success", message: "Stock riven {{name}} has been successfully created." },
      },
      update_stock_riven: {
        error: {
          title: "Update Stock Riven Error",
          title_multiple: "Update Stock Riven Error",
          message: "An error occurred while trying to update stock riven.",
          message_multiple: "An error occurred while trying to update multiple stock rivens.",
        },
        success: {
          title: "Update Stock Riven Success",
          title_multiple: "Update Stock Riven Success",
          message: "Stock riven {{name}} has been successfully updated.",
          message_multiple: "{{count}} stock rivens have been successfully updated.",
        },
      },
      delete_stock_riven: {
        error: {
          title: "Delete Stock Riven Error",
          title_multiple: "Delete Stock Riven Error",
          message: "An error occurred while trying to delete stock riven.",
          message_multiple: "An error occurred while trying to delete multiple stock rivens.",
        },
        success: {
          title: "Delete Stock Riven Success",
          title_multiple: "Delete Stock Riven Success",
          message: "Stock riven {{name}} has been successfully deleted.",
          message_multiple: "{{count}} stock rivens have been successfully deleted.",
        },
      },
      sell_stock_riven: {
        error: { title: "Sell Stock Riven Error", message: "An error occurred while trying to sell stock riven." },
        success: { title: "Sell Stock Riven Success", message: "Stock riven {{name}} has been successfully sold." },
      },
      create_wish_list: {
