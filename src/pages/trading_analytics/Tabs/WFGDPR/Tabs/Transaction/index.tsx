...
export const TransactionPanel = ({ value }: TransactionPanelProps) => {
    ...
    <Box p={3}>
      <DataTableSearch
        ...
        columns={[
          ...
          {
            accessor: "currency",
            title: useTranslateDataGridColumns("currency"),
            sortable: true,
          },
          {
            accessor: "price",
          ...
          {
            accessor: "account",
            title: useTranslateDataGridColumns("account"),
            sortable: true,
          },
          {
            accessor: "sku",
            title: useTranslateDataGridColumns("sku"),
            sortable: true,
          },
        ]}
      />
